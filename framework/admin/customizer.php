...
###################################################################################
    ...
    Kirki::add_field( 'social_resume', array(
        'label'         => __( 'Resume URL', 'agama' ),
        'description'   => __( 'Set your resume url.', 'agama' ),
        'section'       => 'agama_social_icons_section',
        'settings'      => 'social_resume',
        'type'          => 'text',
        'default'       => ''
    ) );
    Kirki::add_field( 'social_visualcv', array(
        'label'         => __( 'Visual CV URL', 'agama' ),
        'description'   => __( 'Set your visual CV url.', 'agama' ),
        'section'       => 'agama_social_icons_section',
        'settings'      => 'social_visualcv',
        'type'          => 'text',
        'default'       => ''
    ) );
###################################################################################
